...
- **Leaving or being removed from a group** (owner-decided v1, 2026-07-17 — issue #329) cancels the member's spot on that group's upcoming events, including a held waitlist position, and frees any seat for the next waitlisted member; past-event RSVPs are left alone as attendance history.
