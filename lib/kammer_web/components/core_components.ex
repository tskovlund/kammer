defmodule KammerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KammerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KammerWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  """
  @spec translate_errors(keyword() | [{atom(), term()}], atom()) :: [String.t()]
